                ...
                <div class="container">
                    <div class="row align-items-end">
                        <div class="col-10">
                            <form>
                                <div class="container">
                                    <label for="find">Seleccione el tipo de búsqueda:</label>
                                    <div class="row">
                                        <div class="col-4">
                                            <select name="find" id="find" class="form-select">
                        ...
                        <div class="col-2">
                            <button @click="openModalForm()" class="btn float-left"><i class="bi bi-plus-circle"></i> new Customer </button>
                        </div>
                    </div>
                </div>
            </div>
